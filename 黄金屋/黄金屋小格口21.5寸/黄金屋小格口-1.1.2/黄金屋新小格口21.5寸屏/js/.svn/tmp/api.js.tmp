...
// var ajax_url = 'http://192.168.1.18:8080/appInterface/'
...
var interface_name = {
	...
	method_borrow_book_userName: 'borrow_book_by_userName', //输入账号密码借书,FRID版过期
	...
	method_return_book_end:'return_book_end', //还书关门接口
	...
	method_notice_list: 'notice_list_shelfId', //问题列表
	...
	method_selfcheck:'selfcheck', //自检问题上报
	...
	method_timerOnOff:"timerOnOff", //设置开关灯时间
}
...
var localcacheName = {
	...
	method_bookcode:"bookCode",
	method_readId:"readId",
	method_cellNo:"cellNo"
}

//常量
var now_time,doc=document,bigImgCount=0,countDown,writeInput;
...
var cellListPageController,
    ...
    global_BOOK_CODE_LENGTH=10//录入书本的编码长度

...
Page({
  ...
  bookTap:function(e){
    ...
    GetReq.GetReq('bookXq', data, function (res) {
      ...
      var bookContent = res.bookContent.substring(0, 160) + '...';
      t.setData({
        flag: false,
        bookDetailImg: res.bookPic,
        bookDetailName: res.bookName,
        bookDetailAuthor: res.bookAuthor,
